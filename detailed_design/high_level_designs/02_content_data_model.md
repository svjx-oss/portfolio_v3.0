...
No `authors.json` — Things is single-author and the index does not repeat author information.
...
- `headings` includes authored H1/H2 headings. Things bodies are H2-led; `ThingsPostPage` prepends the separately rendered post-title H1 to the TOC.
